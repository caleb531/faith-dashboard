  ...
  async headers() {
    const headers = [
      ...
      },
      {
        ...
        value: "default-src 'none'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src * data:; script-src 'self' https://storage.googleapis.com www.googletagmanager.com 'unsafe-inline' 'unsafe-eval'; child-src 'self'; connect-src *; manifest-src 'self'; media-src *;"
      }
    ];
